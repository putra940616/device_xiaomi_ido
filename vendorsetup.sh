...
cd hardware/libhardware/include/hardware && wget https://raw.githubusercontent.com/LineageOS/android_hardware_libhardware/lineage-18.1/include/hardware/hwcomposer_defs.h
